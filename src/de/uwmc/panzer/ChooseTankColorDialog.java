...
public class ChooseTankColorDialog extends JDialog{
    ...
    private final JButton setTurretColorButton = new JButton("Rumpf färben...");
    private final JButton setCannonColorButton = new JButton("Kanone färben...");
    ...
    private JPanel createPreviewPanel() {
        JLabel titleLabel = new JLabel("Panzer Vorschau");
